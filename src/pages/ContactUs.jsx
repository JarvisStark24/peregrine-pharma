  ...
  return (
    <div className="text-black py-20">
      <div className="max-w-6xl mx-auto px-4 md:px-8 flex flex-col md:flex-row items-center gap-0">
        ...
        <div className="flex flex-col w-full md:w-1/2 lg:w-3/5 space-y-6">
          ...
          <div className="text-left mt-20">
            ...
            <div className="space-y-3 text-gray-700">
              ...
              <p className="flex items-center gap-2 transform transition-transform duration-200 hover:scale-105">
                ...
                <a href="mailto:info@peregrinefalcon.com" className="text-blue-600">
          ...
          <form className="space-y-4">
            ...
            <button 
              type="submit" 
              className="w-full bg-customBlue text-white py-2 
              rounded-md hover:bg-customRed transition duration-300"
            >
              Send Message
            </button>
          </form>
